...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/sanxzy/mandor/main/install.sh | sh
#   curl -fsSL https://raw.githubusercontent.com/sanxzy/mandor/main/install.sh | sh -s -- --help
#
# Options:
